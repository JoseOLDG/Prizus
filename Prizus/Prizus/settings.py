"""
Django settings for Prizus project.
...
SECRET_KEY = 'django-insecure-=@1$(b$ozesh+x6%oikfytc%sq%fy8b2%3)x0(p%yy$hnmt7jn'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            ...
            'secret': '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',
            'key': ''
        },
        'SCOPE': [
            'profile',
