...
from .views import index, login, login2, registro, menu, admin_dashboard, admin_perfumes, admin_perfumes_detail ,admin_precios, admin_precios_actualizar ,admin_tendencias, new_prices
